        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-5xl font-bold mb-4">
              Land <span className="block text-[#771D1D]">Plots</span>
            </h1>
            ...
            {plots.map((plot) => (
              <div key={plot.id} className="bg-white rounded-lg shadow-md overflow-hidden group">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 bg-[#771D1D] text-white px-2 py-1 rounded-lg text-xs font-semibold capitalize">
                    {plot.use_type}
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-gray-600 mb-3">
                    <div className="flex items-center"><Maximize className="w-4 h-4 mr-1 text-[#771D1D]" /><span className="text-sm">{plot.size}</span></div>
                  </div>
                  
                  <div className="text-xl font-bold text-[#771D1D] mb-3">{formatPrice(plot.price, plot.currency)}</div>
