...
export default function ApartmentPage() {
  ...
  if (loading) return <div className="min-h-screen bg-white flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#771D1D]"></div></div>;
      ...
      <section className="relative h-96">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-5xl font-bold mb-4">Modern <span className="block text-[#771D1D]">Apartments</span></h1>
            ...
            {apartments.map((apartment) => (
              <div key={apartment.id} className="bg-white rounded-lg shadow-md overflow-hidden group">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 bg-[#771D1D] text-white px-2 py-1 rounded-full text-xs font-semibold">Featured</div>
                </div>
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between text-gray-600 mb-3">
                    <div className="flex items-center"><Bed className="w-4 h-4 mr-1 text-[#771D1D]" /><span className="text-sm">{apartment.beds}</span></div>
                    <div className="flex items-center"><Bath className="w-4 h-4 mr-1 text-[#771D1D]" /><span className="text-sm">{apartment.baths}</span></div>
                    <div className="flex items-center"><Maximize className="w-4 h-4 mr-1 text-[#771D1D]" /><span className="text-sm">{apartment.area}</span></div>
                  </div>
                  <div className="text-xl font-bold text-[#771D1D] mb-3">{formatPrice(apartment.price)}</div>
                  ...
                  <button className="w-full mt-2 border-2 border-gray-200 text-gray-700 py-2 rounded-lg text-sm font-semibold hover:border-[#771D1D] hover:text-[#771D1D] transition-colors">View Details</button>
                </div>
              </div>
            ))}
          </div>
