      ...
      <section className="relative h-96">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-5xl font-bold mb-4">Commercial <span className="block text-[#771D1D]">Properties</span></h1>
            ...
            {commercials.map((property) => (
              <div key={property.id} className="bg-white rounded-lg shadow-md overflow-hidden group">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 bg-[#771D1D] text-white px-2 py-1 rounded-lg text-xs font-semibold">{property.type}</div>
                </div>
                <div className="p-4">
                  ...
                  <div className="text-xl font-bold text-[#771D1D] mb-3">{formatPrice(property.price)}</div>
